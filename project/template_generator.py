        ...
        'payment': {
            ...
            'wide': {
                ...
                'notes': [
                    ...
                    '【结算时间】结算完成时间为结算办理完成的日期，结算资料归档时间为结算资料归档的日期，格式：YYYY-MM-DD',
